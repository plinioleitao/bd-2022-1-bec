...
1. **Na sua conta do GitHub**, criar um repositório necessariamente '**publico**' de nome **bd-2022-1-bec**:
   - ou seja, letras minúsculas e hífen para separação: **bd**, **2022**, **1** e **bec**;
   - então, a URL do repositório será https://github.com/contagithub/bd-2021-1-bec, onde _**contagithub**_ é conta do aluno no GitHub (por exemplo, a conta do professor no GitHub é _**plinioleitao**_).
1. Criar uma _issue_ no projeto https://github.com/plinioleitao/bd-2021-1-bec. Esta _issue_ irá identificar cada estudante da disciplina:
