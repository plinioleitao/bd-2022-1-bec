...
π <sub>CPF</sub> (π <sub>CPF, Salario</sub> (R)) = π <sub>CPF, Salario</sub> (π <sub>CPF</sub> (R))
...
Criar uma _issue_ no projeto https://github.com/plinioleitao/bd-2022-1-bec, com o título "Tópico 09", para responder:  
...
1. _Issue_ criada no projeto https://github.com/plinioleitao/bd-2022-1-bec, cujo título é "Tópico 09", para indicar suas reflexões iniciais sobre *restrições de integridade no modelo relacional*.
